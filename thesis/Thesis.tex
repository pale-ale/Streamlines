...
\usepackage[%
  ...
  urlcolor   = BrickRed,
  % pdftex,
  pdfauthor={Alexander Baucke},
  pdftitle={Time-Coherent Streamline Placment},
...
\frontmatter
  ...
  % \include{Sources/Title_Dissertation}  % for PhD thesis
  \pagestyle{empty}
  \include{Sources/DeclarationOfAuthorship}  % remove for PhD thesis
