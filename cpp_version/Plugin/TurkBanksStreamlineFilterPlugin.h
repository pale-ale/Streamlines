...
class TurkBanksStreamlineFilterPlugin :
#if _paraview_add_plugin_with_ui
  public QObject,
...

{
  ...
  Q_PLUGIN_METADATA(IID "com.kitware/paraview/TurkBanksStreamlineFilterPlugin")
#endif
public:
  TurkBanksStreamlineFilterPlugin();

  /**
   * Returns the name for this plugin.
   */
  const char* GetPluginName() override
    {return "TurkBanksStreamlineFilter"; }
  ...
  const char* GetDescription() override
    { return "A plugin that adds a streamline filter using Turk and Banks' algorithm, extended with time coherence."; }
